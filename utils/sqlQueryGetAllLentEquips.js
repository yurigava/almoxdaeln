module.exports = exports = `SELECT EquipamentosMonitorados_patrimonio, usuario FROM
    (SELECT t1.EquipamentosMonitorados_patrimonio, t1.usuario, t1.Estados_id_estado FROM HistoricoEquipamentos t1
      JOIN (
