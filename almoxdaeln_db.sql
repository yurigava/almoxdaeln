...
CREATE TABLE `EquipamentosMonitorados` (
  ...
  CONSTRAINT `fk_EquipamentosMonitorados_Estados1` FOREIGN KEY (`Estados_id_estado`) REFERENCES `Estados` (`id_estado`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_EquipamentosMonitorados_Tipos1` FOREIGN KEY (`Tipos_id_tipo`) REFERENCES `Tipos` (`id_tipo`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2017-06-10 16:20:29
