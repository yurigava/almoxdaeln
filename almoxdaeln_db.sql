...
INSERT INTO `EquipamentosMonitorados` VALUES (78930384,1,32),(7890552036199,1,2),(7896004743226,1,32),(7896308078048,1,2);
...
CREATE TABLE `EquipamentosRequisicao` (
  `id_EquipamentoRequisicao` bigint(20) NOT NULL AUTO_INCREMENT,
  `quantidade` int(8) NOT NULL,
  `Tipos_id_tipo` int(32) DEFAULT NULL,
  `Familias_id_familia` int(32) NOT NULL,
  `Requisicoes_id_requisicao` bigint(20) NOT NULL,
  ...
  CONSTRAINT `fk_EquipamentosRequisicao_Tipos1` FOREIGN KEY (`Tipos_id_tipo`) REFERENCES `Tipos` (`id_tipo`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `HistoricoEquipamentos` VALUES (1,'2017-10-27 00:24:19','Criação','admin',78930384,4),(2,'2017-10-27 00:24:19','Criação','admin',7890552036199,4),(3,'2017-10-27 00:24:19','Criação','admin',7896004743226,4),(4,'2017-10-27 00:24:19','Criação','admin',7896308078048,4),(5,'2017-10-27 00:27:24',NULL,'201509002872',7896004743226,1),(6,'2017-10-27 00:27:25',NULL,'201509002872',7890552036199,1),(7,'2017-10-27 00:52:11',NULL,'201509002872',7896308078048,1),(8,'2017-10-27 00:53:12',NULL,'201509002872',7896308078048,4),(9,'2017-10-27 00:53:12',NULL,'201509002872',7890552036199,4),(10,'2017-10-27 00:53:12',NULL,'201509002872',7896004743226,4),(11,'2017-10-27 00:53:26',NULL,'201509002872',7896308078048,1),(12,'2017-10-27 00:53:26',NULL,'201509002872',7896004743226,1),(13,'2017-10-27 00:53:44',NULL,'1',78930384,1),(14,'2017-10-27 00:53:45',NULL,'1',7890552036199,1);
...
CREATE TABLE `Requisicoes` (
  `id_requisicao` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `Usuarios` (
  ...
  PRIMARY KEY (`id_user`),
  UNIQUE KEY `user_UNIQUE` (`id_user`)
...
INSERT INTO `Usuarios` VALUES (1,'yuri','admin'),(2,'nada','almox');
...
-- Dump completed on 2017-11-08  0:24:04
