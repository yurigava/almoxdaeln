...
CREATE TABLE `EquipamentosMonitorados` (
  ...
  KEY `fk_EquipmentList_Tipos_idx` (`Tipos_id_tipo`),
  CONSTRAINT `fk_EquipamentosMonitorados_Estados1` FOREIGN KEY (`Estados_id_estado`) REFERENCES `Estados` (`id_estado`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_EquipamentosMonitorados_Tipos1` FOREIGN KEY (`Tipos_id_tipo`) REFERENCES `Tipos` (`id_tipo`) ON DELETE NO ACTION ON UPDATE CASCADE
...
CREATE TABLE `HistoricoEquipamentos` (
  ...
  `Requisicoes_id_evento` int(32) DEFAULT NULL,
  ...
  KEY `fk_HistoricoEquipamentos_Requisicoes1_idx` (`Requisicoes_id_evento`),
  CONSTRAINT `fk_HistoricoEquipamentos_EquipamentosMonitorados1` FOREIGN KEY (`EquipamentosMonitorados_patrimonio`) REFERENCES `EquipamentosMonitorados` (`patrimonio`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_HistoricoEquipamentos_Requisicoes1` FOREIGN KEY (`Requisicoes_id_evento`) REFERENCES `Requisicoes` (`id_requisicao`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Requisicoes` (
  ...
  CONSTRAINT `fk_Requisicao_EstadosReq1` FOREIGN KEY (`EstadosReq_id_estadosReq`) REFERENCES `EstadosReq` (`id_estadosReq`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-06-03  2:33:41
