...
export default class StudentLend extends React.Component {
  ...
  handleCloseDialog() {
    if(this.props.isDataSubmitted) {
      ...
      let message = "";
      if(this.props.errorCode === "ER_NOT_FOUND")
        message = "Equipamento Não Registrado";
      else if(this.props.errorCode === "ER_NOT_AVAILABLE")
  ...
  handleRemoveEquipment(event) {
    ...
    let newInfoNumber = 2;
    if(this.state.barCodes.length < 4)
      newInfoNumber = 1;
    this.setState(update(this.state, {
  ...
  handleFormSubmit(event) {
    ...
    this.props.insertStudentLend(usuario, patrimonios)
  }
