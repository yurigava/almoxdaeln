        ...
        >
          ...
          >
            <TableRow>
              ...
              <TableHeaderColumn>Matéria</TableHeaderColumn>
            </TableRow>
          </TableHeader>
          ...
          >
            {this.props.reserves.map( (reserve) => (
              <TableRow
                ...
                onTouchTap={this.handleReserveSelect}
              >
                <TableRowColumn>{reserve.idReq}</TableRowColumn>
                <TableRowColumn>{reserve.quantidade}</TableRowColumn>
                <TableRowColumn>{reserve.user}</TableRowColumn>
                <TableRowColumn>{reserve.materia}</TableRowColumn>
              </TableRow>
            ))}
          </TableBody>
        </Table>
