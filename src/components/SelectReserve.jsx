...
export default class SelectReserve extends React.Component {
  ...
  handleReserveSelect(usuario, id) {
    this.props.clearReserves();
    this.props.getReserveDetails(usuario, id);
    this.props.setInfoNumber(0);
    ...
    return (
      <div>
        ...
        >
          ...
          >
            <TableRow>
              <TableHeaderColumn style={{fontSize: '16px'}}>ID</TableHeaderColumn>
          ...
          >
            {this.props.reserves.map( (reserve) => (
              <TableRow
                ...
                onTouchTap={() => this.handleReserveSelect(idReq.user, reserve.idReq)}
              >
                <TableRowColumn style={{fontSize: '16px'}}>{reserve.idReq}</TableRowColumn>
