...
export default class ReadEquipsReserve extends React.Component {
  ...
  componentWillUpdate(nextProps) {
    ...
    this.props.barCodes.forEach((barCode, barCodeIndex) => {
      ...
      if(barCode.errorCode == "ER_NOT_AVAILABLE") {}
      else if(this.props.barCodes.filter(repBar => repBar.value == barCode.value).length > 1)//equip already exists in array
        this.props.setBarcodeErrorCode(barCodeIndex, "ER_REPEATED_EQUIP");
      else if(newTipoIndexReserve !== null && newTipoIndexReserve >= 0) {
        this.props.incrementMissingReserve(newTipoIndexReserve);
        this.props.setBarcodeErrorCode(barCodeIndex, "");
      }
        ...
        this.props.setBarcodeErrorCode(barCodeIndex, "ER_WRONG_EQUIP");
              ...
              {this.props.barCodes.map((barCode, index) => (
                <Row key={index} bottom="xs" center="xs" style={{position: "relative"}}>
                  <Col xs={10}>
                    ...
                    />
                    {barCode.equipTipo && barCode.errorCode == '' ?
                      <Paper
                        zDepth={2}
                        rounded={false}
