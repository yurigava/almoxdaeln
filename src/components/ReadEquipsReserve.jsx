      ...
      reserveInfo = this.props.reserveEquips.map((value, index) => (
        ...
        >
          ...
          <Col xs={2}>
            ...
            <div style={{display: 'inline-block', width: '42.55', marginLeft: value.current >= value.total ? '' : '24px'}}>
              <div style={{textAlign: 'center', marginLeft: value.current < 10 && value.total >=10 ? '9px' : ''}}>
