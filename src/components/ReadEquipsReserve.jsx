...
export default class ReadEquipsReserve extends React.Component {
  ...
  handleSendRequest(event) {
    ...
    this.props.clearBarcodes();
    this.props.registerReservedEquips(this.props.requisicao, this.props.usuario, this.state.selectedCarrinhos,
        this.props.barCodes.filter(equip => equip.errorCode === "" && equip.value !== "").map(equip => Number(equip.value)))
  }
