...
const infoText = "Clique em 'MARCAR COMO CONFERIDO' para aceitar ou clique em um item para conferência"
...
export default class VerifyReturnedReserve extends React.Component {
  ...
  handleRegisterReturnedEquips() {
    ...
    this.props.registerReturnedEquips(this.props.reserveId, equipsToRegister, this.props.usuario);
  }
