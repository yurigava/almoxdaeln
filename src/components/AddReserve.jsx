        ...
        >
          ...
          {this.state.patrimonios.map((patrimonio) => (
            ...
            <EquipTypeSelectorContainer
              ...
              //tipo={patrimonio.auxTipo}
              //familia={patrimonio.auxFamilia}
              //setSelectedTipo={patrimonio.auxSetSelectedTipo}
              //setSelectedFamilia={patrimonio.auxSetSelectedFamilia}
              //setInfoText={patrimonio.auxSetInfoText}
              //isMissingTipo={patrimonio.auxIsMissingTipo}
              //isMissingFamilia={patrimonio.auxIsMissingFamilia}
              //isInputDisabled={patrimonio.auxIsInputDisabled}
              style={style_inline}
            />
            &nbsp;
              <TextField
