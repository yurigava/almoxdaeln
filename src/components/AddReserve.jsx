...
export default class AddReserve extends React.Component {
  ...
  handleCloseDialog() {
    if(this.props.isDataSubmitted) {
      ...
      this.state = {
        equipReservados: [
          {index: "", name: "equip0", value: "", errorText: "", familia: "", tipo: "", isMissingTipo: true, isMissingFamilia: true, isInputDisabled: false, maxQuantidade: ""}
        ]
      }
    }
  ...
  funcSetSelectedFamilia(name, familia) {
    ...
    this.props.quantidadeReserve(newValue, null, name);
  }
  ...
  funcSetSelectedTipo(name, tipo) {
    ...
    this.props.quantidadeReserve(this.state.equipReservados[index].familia, newValue, name);
  }
