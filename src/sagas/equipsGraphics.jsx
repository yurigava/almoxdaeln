...
function *quantidadeEquipsGraph(action) {
  ...
  try {
    ...
    if(response.data.code === "SUCCESS") {
      yield put({ type: 'SET_QUANTIDADE_EQUIPGRAPH', quantidadeM: response.data.quantidadeM, quantidadeT: response.data.quantidadeT, quantidadeN: response.data.quantidadeN, referencia: response.data.referencia });
    }
    else {
