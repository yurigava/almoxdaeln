...
export const registerReservedEquips = (serverUrl, usuario, patrimonios) => {
  return {
...
export const getReserveDetails = (serverUrl, usuario, reserveId) => {
  return {
...
export const setBarcodeErrorText = (index, errorText) => {
  return {
...
export const setReserveEquips = (usuario, reserveEquips) => {
  return {
